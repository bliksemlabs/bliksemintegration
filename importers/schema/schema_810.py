...
CREATE TEMPORARY TABLE "confinrel" (
	...
	"implicit"           CHAR(1)       NOT NULL,
	"dataownercode"      VARCHAR(10)   NOT NULL,
	"confinrelcode"      VARCHAR(50)   NOT NULL,
	"concessionareacode" VARCHAR(10)   NOT NULL,
...
CREATE TEMPORARY TABLE "pool" (
	...
	Description VARCHAR(255),
	PRIMARY KEY (Version,DataOwnerCode, UserStopCodeBegin, UserStopCodeEnd, LinkValidFrom, PointDataOwnerCode, PointCode),
	FOREIGN KEY (DataOwnerCode, UserStopCodeBegin, UserStopCodeEnd, LinkValidFrom) REFERENCES link (DataOwnerCode,UserStopCodeBegin, UserStopCodeEnd, ValidFrom),
